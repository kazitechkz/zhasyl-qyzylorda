...
class WorkResultController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("brigadier.work-result.index",compact("results"));
    }
    ...
    public function store(CreateWorkResultRequest $request)
    {
        ...
        return redirect()->route("brigadier-work-result.index");
    ...
    public function show(string $id)
    {
        ...
        if($work){
            ...
            return view("brigadier.work-result.show",compact("work","result"));
        }
    ...
    public function edit(string $id)
    {
        ...
        if($work){
            $result = WorkResult::where(["work_id" => $work->id])->first();
            if($result){
                return redirect()->route("brigadier-work-result.show",$result->id);
            }
            return view("brigadier.work-result.create",compact("work"));
        }
        return redirect()->back();
    }
