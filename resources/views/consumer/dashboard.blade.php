                        ...
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col">
                                <div class="summary">
                                    ...
                                    <div class="info">
                                        <strong class="amount">{{\App\Models\Area::whereIn("id",$areasIds)->count()}}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col">
                                <div class="summary">
                                    ...
                                    <div class="info">
                                        <strong class="amount">{{\App\Models\Place::whereIn("area_id",$areasIds)->count()}}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col">
                                <div class="summary">
                                    ...
                                    <div class="info">
                                        <strong class="amount">{{\App\Models\Marker::where("area_id",$areasIds)->count()}}</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
