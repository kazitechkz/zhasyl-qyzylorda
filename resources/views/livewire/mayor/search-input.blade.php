...
<div class="grid grid-cols-4 gap-4">
    <div class="relative mb-4" data-te-input-wrapper-init>
        ...
        <select name="area_id" wire:model="areaId" class="w-full" data-te-select-init>
...
{{--                <option wire:click="getPlacesByAreaId({{$item->id}})" value="{{$item->id}}">{{$item->title_ru}}</option>--}}
    ...
    <div class="relative mb-4" data-te-input-wrapper-init>
        ...
        <select name="category_id" class="form-control" wire:model="categoryId" wire:change="getPlacesByAreaId">
