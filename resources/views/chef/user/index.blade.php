                            ...
                            @foreach($users as $item)
                                <tr class="border-b dark:border-neutral-500">
                                    ...
                                    <td class="flex justify-end py-4">
                                        ...
                                        <a href="{{route('chef-user.edit', $item->id)}}" class="mr-3">
                                        ...
                                        <form action="{{route('chef-user.destroy', $item->id)}}" method="post">
                                            @csrf
                                            @method('delete')
